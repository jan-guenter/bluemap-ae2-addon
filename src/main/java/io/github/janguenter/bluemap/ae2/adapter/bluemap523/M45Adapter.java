...
final class M45Adapter {
    ...
    private static final ResourcePack.Extension<M45ResourceExtension> EXTENSION =
            new ResourceExtensionType<>(EXTENSION_KEY, M45Adapter::createResourceExtension);
    ...
    private static M45ResourceExtension createResourceExtension(ResourcePack pack) {
