...
# Exact Applied Mekanistics 20-tick retained-state checkpoint.
...
scoreboard players set #appmek_20t ae2amrun -1
execute if score #failures ae2amrun matches 0 run scoreboard players set #appmek_20t ae2amrun 1
