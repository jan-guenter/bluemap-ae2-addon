...
# Exact Applied Mekanistics 100-tick retained-state checkpoint.
...
scoreboard players set #appmek_100t ae2amrun -1
execute if score #failures ae2amrun matches 0 run scoreboard players set #appmek_100t ae2amrun 1
